...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('feedback_feedback', 'ip_address', self.gf('django.db.models.fields.IPAddressField')(max_length=15, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Feedback.ip_address'
        db.delete_column('feedback_feedback', 'ip_address')
